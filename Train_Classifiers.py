...
short_angry = open("angry.txt","r").read()
short_disgust = open("disgust.txt","r").read()
short_fear = open("fear.txt","r").read()
short_guilt = open("guilt.txt","r").read()
short_joy = open("joy.txt","r").read()
short_sad = open("sad.txt","r").read()
short_shame = open("shame.txt","r").read()
...
# for p in short_angry.split('\n'):
#     documents.append( (p, "angry") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
#             all_words.append(w[0].lower())
#
# for p in short_joy.split('\n'):
#     documents.append( (p, "joy") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
#             all_words.append(w[0].lower())
#
# for p in short_disgust.split('\n'):
#     documents.append( (p, "disgust") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
#             all_words.append(w[0].lower())
#
# for p in short_fear.split('\n'):
#     documents.append( (p, "fear") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
#             all_words.append(w[0].lower())
#
# for p in short_guilt.split('\n'):
#     documents.append( (p, "guilt") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
...
#             all_words.append(w[0].lower())
#
# for p in short_shame.split('\n'):
#     documents.append( (p, "shame") )
#     words = word_tokenize(p)
#     pos = nltk.pos_tag(words)
#     for w in pos:
#         if w[1][0] in allowed_word_types:
